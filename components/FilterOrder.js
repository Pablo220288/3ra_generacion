...
export default function FilterOrder({ categories, customer, selectCustomer }) {
  return (
    <div className="my-4 flex items-start gap-6 ">
      <h1 className="text-sm text-gray-600 pt-4 pl-2">Filtrar</h1>
      <div className="flex flex-col items-center gap-6 ">
        <div className="relative h-11 w-full max-w-[270px]">
          <select
            value={customer}
            onChange={(ev) => {
              selectCustomer(ev);
