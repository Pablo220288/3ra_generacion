      ...
      {items.length > 0 &&
        items.map((item, index) => (
          <div className="flex gap-4 mb-1 mt-4" key={index}>
            ...
            <div className="relative h-11 max-w-[100px]">
              <input
...
/* export default function BudgetForm({
  ...
  const addItem = (title) => {
    const newItem = items.map((item) => {
      if (item.title === title) {
        item.items.push({ name: "", cant: 1, price: "", total: "0" });
        return item;
      }
      return item;
    });
  ...
  const handleItemNameChange = (index, title, i, newName) => {
    const changeNameItem = items.map((item) => {
      if (item.title === title) {
        item.items[index].name = newName;
        return item;
      }
      return item;
    });
    setItems(changeNameItem);
  };
  const handleItemCantChange = (index, title, i, newCant) => {
    const changeCantItem = items.map((item) => {
      if (item.title === title) {
    ...
    setItems(changeCantItem);
  };
  const handleItemPriceChange = (index, title, i, newPrice) => {
    const changePriceItem = items.map((item) => {
      if (item.title === title) {
        ...
        items.map((item, index) => (
          <div className="flex flex-col gap-4 mb-1 mt-4" key={index}>
            ...
            {item.items?.map((i, index) => (
              <div className="flex gap-4 mb-1 mt-2 ml-2" key={index}>
                <button
                  ...
                  type="button"
                  className="flex w-fit px-4 cursor-pointer select-none items-center rounded-md text-start text-blue-gray-600 leading-tight outline-none transition-all hover:bg-pink-50 hover:bg-opacity-80 hover:text-pink-900 focus:bg-pink-50 focus:bg-opacity-80 focus:text-pink-900 active:bg-pink-50 active:bg-opacity-80 active:text-pink-900"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
            ...
            <button
              ...
              className="block w-fit select-none rounded-lg bg-teal-500 p-2 mt-4 ml-2 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-teal-500/20 transition-all hover:shadow-lg hover:shadow-teal-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
      ...
      <div className="flex items-center gap-2 mt-4">
        <div className="relative h-11 w-full max-w-[200px]">
          <input
            ...
            placeholder=" "
            value={titleSection}
            onChange={(ev) => setTitleSection(ev.target.value)}
          />
          <label className="before:content[' '] after:content[' '] pointer-events-none absolute left-0 -top-1.5 flex h-full w-full select-none text-[11px] font-normal leading-tight text-blue-gray-400 transition-all before:pointer-events-none before:mt-[6.5px] before:mr-1 before:box-border before:block before:h-1.5 before:w-2.5 before:rounded-tl-md before:border-t before:border-l before:border-blue-gray-200 before:transition-all after:pointer-events-none after:mt-[6.5px] after:ml-1 after:box-border after:block after:h-1.5 after:w-2.5 after:flex-grow after:rounded-tr-md after:border-t after:border-r after:border-blue-gray-200 after:transition-all peer-placeholder-shown:text-sm peer-placeholder-shown:leading-[4.1] peer-placeholder-shown:text-blue-gray-500 peer-placeholder-shown:before:border-transparent peer-placeholder-shown:after:border-transparent peer-focus:text-[11px] peer-focus:leading-tight peer-focus:text-indigo-500 peer-focus:before:border-t-2 peer-focus:before:border-l-2 peer-focus:before:!border-indigo-500 peer-focus:after:border-t-2 peer-focus:after:border-r-2 peer-focus:after:!border-indigo-500 peer-disabled:text-blue-gray-500 peer-disabled:before:border-transparent peer-disabled:after:border-transparent peer-disabled:peer-placeholder-shown:text-blue-gray-500">
            Titulo
          </label>
        ...
        <button
          ...
          className="block w-fit select-none rounded-lg bg-gray-500 p-2 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-gray-500/20 transition-all hover:shadow-lg hover:shadow-gray-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
