...
export default function VisualizeOrderPage() {
  ...
  return (
    <Layout>
      ...
      {order && (
        <div className="w-full max-w-[650px] mx-auto mb-6 flex flex-col">
          <div className="flex gap-1 mb-4">
            ...
            >
              <button className="flex w-fit cursor-pointer select-none items-center gap-2 rounded-md p-2 text-start text-blue-gray-600 leading-tight outline-none transition-all hover:bg-red-50 hover:bg-opacity-80 hover:text-red-900 focus:bg-red-50 focus:bg-opacity-80 focus:text-red-900 active:bg-red-50 active:bg-opacity-80 active:text-red-900">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
          ...
          <div className=" w-full flex flex-col items-center rounded-lg p-4 bg-gray-50 shadow-md backdrop-blur-2xl backdrop-saturate-200">
